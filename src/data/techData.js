...
export const TECH_STACK = {
  ...
  {id:'rag-service',name:'RAG Service',category:'RAG / Retrieval',description:'Embedding + vector search API',preset:{backend:['fastapi'],aiFrameworks:['langchain'],llmProviders:['openai'],protocols:[]}},
  {id:'pdf-chat',name:'PDF Chat',category:'RAG / Retrieval',description:'Upload PDFs and chat over content',preset:{frontend:['react'],backend:['fastapi'],aiFrameworks:['langchain'],llmProviders:['openai'],protocols:[]}},
  {id:'vector-ingest',name:'Vector Ingest Pipeline',category:'RAG / Retrieval',description:'Chunking + embedding loader service',preset:{backend:['fastapi'],aiFrameworks:['langchain'],llmProviders:['openai'],protocols:[]}},
  ...
  {id:'knowledge-base',name:'Knowledge Base Portal',category:'Knowledge',description:'Docs site + semantic search',preset:{frontend:['react'],backend:['fastapi'],aiFrameworks:['langchain'],llmProviders:['openai'],protocols:[]}},
  ]
};
